...
const defaultMenuItems = [
  ...
  { id: 11, name: '48pcs Mix Kimbap', category: 'sushi', price: 555, stock: 50, emoji: '🍙', description: 'Delicious Korean-style kimbap' },
  ...
  // Solo Maki Rolls
  { id: 118, name: 'Crab Cheese Roll', category: 'sushi', price: 150, stock: 50, emoji: '🍣', description: 'Sushi roll with crab and cream cheese' },
  { id: 119, name: 'Crab Kani (8pcs)', category: 'sushi', price: 250, stock: 50, emoji: '🍣', description: 'Kani sushi rolls' },
  { id: 120, name: 'Crabgo (8pcs)', category: 'sushi', price: 150, stock: 50, emoji: '🍣', description: 'Kani crab rolls' },
  { id: 121, name: 'Crabstick Roll', category: 'sushi', price: 150, stock: 50, emoji: '🍣', description: 'Classic crabstick sushi roll' },
  { id: 122, name: 'Creamy Cheese Roll', category: 'sushi', price: 150, stock: 50, emoji: '🍣', description: 'Extra creamy cheese roll' },
  { id: 123, name: 'Crunchy Cheese (10pcs)', category: 'sushi', price: 160, stock: 50, emoji: '🍣', description: 'Crunchy cheese roll' },
  ...
  { id: 126, name: '10pcs Mango Cheese Roll', category: 'sushi', price: 150, stock: 50, emoji: '🍣', description: 'Sweet mango and cheese roll' },
  { id: 127, name: '8pcs Crazy Maki', category: 'sushi', price: 120, stock: 50, emoji: '🍣', description: 'Spicy crazy maki rolls' },
  { id: 128, name: '8pcs Riri Cheese Roll', category: 'sushi', price: 130, stock: 50, emoji: '🍣', description: 'Special riri cheese roll' },
  { id: 129, name: '8pcs Sweet and Spicy Maki', category: 'sushi', price: 120, stock: 50, emoji: '🍣', description: 'Sweet and spicy glazed maki' },
  { id: 130, name: 'Veggie Roll', category: 'sushi', price: 180, stock: 50, emoji: '🍣', description: 'Fresh vegetable sushi roll' },
