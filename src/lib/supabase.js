...
const defaultMenuItems = [
  ...
  { id: 121, name: '8pcs Crabstic Roll', category: 'solo', price: 150, stock: 50, emoji: '🍣', description: 'Classic crabstick sushi roll' },
  { id: 122, name: '8pcs Creamy Cheese', category: 'solo', price: 150, stock: 50, emoji: '🍣', description: 'Extra creamy cheese roll' },
  ...
  { id: 128, name: '8pcs Riri Cheese', category: 'solo', price: 130, stock: 50, emoji: '🍣', description: 'Special riri cheese roll' },
  { id: 129, name: '8pcs Sweet & Spicy', category: 'solo', price: 120, stock: 50, emoji: '🍣', description: 'Sweet and spicy glazed maki' },
  { id: 130, name: 'Veggie Roll', category: 'solo', price: 180, stock: 50, emoji: '🍣', description: 'Fresh vegetable sushi roll' },
  { id: 184, name: '8pcs California Maki', category: 'solo', price: 115, stock: 50, emoji: '🍣', description: 'Classic California maki' },
  { id: 177, name: '8pcs Sweet Molly', category: 'solo', price: 120, stock: 50, emoji: '🍣', description: 'Sweet maki roll' },
  { id: 165, name: '8pcs Crabgo Sushi', category: 'solo', price: 150, stock: 50, emoji: '🍣', description: 'Kani crab sushi' },
  ...
  // 10pcs variants for solo maki rolls
  { id: 219, name: '10pcs California Maki', category: 'solo', price: 140, stock: 50, emoji: '🍣', description: 'Classic California maki' },
  { id: 220, name: '10pcs Riri Cheese', category: 'solo', price: 160, stock: 50, emoji: '🍣', description: 'Special riri cheese roll' },
  { id: 221, name: '10pcs Crabgo Sushi', category: 'solo', price: 180, stock: 50, emoji: '🍣', description: 'Kani crab sushi' },
  { id: 222, name: '10pcs Creamy Cheese', category: 'solo', price: 180, stock: 50, emoji: '🍣', description: 'Extra creamy cheese roll' },
  { id: 223, name: '10pcs Crabstic Roll', category: 'solo', price: 220, stock: 50, emoji: '🍣', description: 'Classic crabstick sushi roll' },
  { id: 224, name: '10pcs Sweet Molly', category: 'solo', price: 150, stock: 50, emoji: '🍣', description: 'Sweet maki roll' },
  { id: 225, name: '10pcs Sweet & Spicy', category: 'solo', price: 150, stock: 50, emoji: '🍣', description: 'Sweet and spicy glazed maki' },
